        ...
        <div class="templatemo-welcome" id="templatemo-welcome">
            <div class="container">
                <div class="templatemo-slogan text-center">
                    <span class="txt_darkgrey">Welcome to </span><div class="dropdown"><button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" style="-webkit-box-shadow: 0 10px 6px -6px #777;
    -moz-box-shadow: 0 10px 6px -6px #777;
    box-shadow: 0 10px 6px -6px #777;"><span class="txt_orange"  style="font-size:58px ">VIỄN ĐÔNG</span> </button> <ul class="dropdown-menu">
      <li style="width: 338px;"><a href="{{ route('events.indexhvh')}}">HỒN VIỆT </a></li>
