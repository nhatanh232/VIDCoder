...
@section('body')
 ...
 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" style="background: #4CAF50" ><h1>YOGA</h1>
...
<input type="text" value="Phòng Yoga" name="diadiem" style="display: none">
