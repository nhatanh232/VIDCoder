...
@section('body')
 ...
 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" style="background: #4CAF50" ><h1>BẾP</h1>
...
<ul class="dropdown-menu" style="width: 100%;
   ...
   "><li><a href="{{route('tongviec')}}">Danh sách công việc các phòng</a></li>
    <li><a href="{{ route('events.indexh')}}">PHÒNG HỌP</a></li>
    <li><a href="{{ route('events.indexvdzen')}}">PHÒNG ZEN </a></li>
    <li><a href="{{ route('events.indexvdnons1')}}">PHÒNG NONSELF 1</a></li>
    <li><a href="{{ route('events.indexvdnons2')}}">PHÒNG NONSELF 2</a></li>
     <li><a href="{{ route('events.indexvdht')}}">HỘI TRƯỜNG</a></li>
      <li><a href="{{ route('events.indexvdsbong')}}">SÂN BÓNG</a></li>
       <li><a href="{{ route('events.indexvdshgt')}}">PHÒNG SINH HOẠT GIẢI TRÍ</a></li>
        <li><a href="{{ route('events.indexvdkid')}}">PHÒNG KID</a></li>
         <li><a href="{{ route('events.indexvdyoga')}}">PHÒNG YOGA</a></li>
          <li><a href="{{ route('events.index')}}">PHÒNG KAI</a></li>
           <li><a href="{{ route('events.indexvdminigym')}}">PHÒNG MINI GYM</a></li>
              ...
              <div class="panel-body">    
                   ...
                   {!! Form::open(array('route' => 'events.addbep','method'=>'POST','files'=>'true')) !!}
                    <div class="row">
                      ...
                      <input type="text" value="Bếp" name="diadiem" style="display: none">
                      <div class="col-xs-4 col-sm-4 col-md-3">
                        <input type="text" value="Phòng Họp" name="diadiem" style="display: none">
