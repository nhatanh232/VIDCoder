...
@section('body')
 ...
 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" style="background: #4CAF50" ><h1>PHÒNG SINH HOẠT GIẢI TRÍ</h1>
...
<ul class="dropdown-menu" style="width: 100%;
   ...
   "> <li><a href="{{route('tongviec')}}">Danh sách công việc các phòng</a></li>
    ...
    <li><a href="{{ route('events.indexvdnons2')}}">PHÒNG NONSELF 2</a></li>
     <li><a href="{{ route('events.indexbep')}}">BẾP</a></li>
          ...
          <li><a href="{{ route('events.index')}}">PHÒNG KAI</a></li>
           <li><a href="{{ route('events.indexvdminigym')}}">PHÒNG MINI GYM</a></li>
              ...
              <div class="panel-body">    
                   ...
                   {!! Form::open(array('route' => 'events.addvdshgt','method'=>'POST','files'=>'true')) !!}
                    <div class="row">
...
<input type="text" value="Phòng sinh hoạt giải trí" name="diadiem" style="display: none">
