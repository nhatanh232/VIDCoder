...
@section('body')
 ...
 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" style="background: #4CAF50" ><h1>MINI GYM</h1>
          ...
          <li><a href="{{ route('events.index')}}">PHÒNG KAI</a></li>
           <li><a href="{{ route('events.indexvdht')}}">HỘI TRƯỜNG</a></li>
              ...
              <div class="panel-body">    
                   ...
                   {!! Form::open(array('route' => 'events.addvdminigym','method'=>'POST','files'=>'true')) !!}
                    <div class="row">
...
<input type="text" value="Phòng Mini gym" name="diadiem" style="display: none">
