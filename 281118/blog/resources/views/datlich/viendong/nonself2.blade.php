...
@section('body')
 ...
 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" style="background: #4CAF50" ><h1>NONSELF 2</h1>
          ...
          <li><a href="{{ route('events.index')}}">PHÒNG KAI</a></li>
           <li><a href="{{ route('events.indexvdminigym')}}">PHÒNG MINI GYM</a></li>
              ...
              <div class="panel-body">    
                   ...
                   {!! Form::open(array('route' => 'events.addvdnons2','method'=>'POST','files'=>'true')) !!}
                    <div class="row">
...
<input type="text" value="Phòng Nonselft 2" name="diadiem" style="display: none">
