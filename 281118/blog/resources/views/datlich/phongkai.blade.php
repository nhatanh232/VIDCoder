...
@section('body')
 ...
 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" style="background: #4CAF50" ><h1>PHÒNG KAI</h1>
 ...
 <ul class="dropdown-menu" style="width: 100%;
   ...
   "> <li><a href="{{route('tongviec')}}">Danh sách công việc các phòng</a></li>
    ...
    <li><a href="{{ route('events.indexvdnons2')}}">PHÒNG NONSELF 2</a></li>
     <li><a href="{{ route('events.indexvdht')}}">PHÒNG HỘI TRƯỜNG</a></li>
...
<input type="text" value="Phòng Kai" name="diadiem" style="display: none">
