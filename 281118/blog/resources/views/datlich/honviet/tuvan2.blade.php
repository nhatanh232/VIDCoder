...
@section('body')
  ...
  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" style="background: #4CAF50" ><h1>TƯ VẤN 2</h1>
   ...
   "><li><a href="{{route('tongviechv')}}">Danh sách công việc các phòng</a></li>
    ...
    <li><a href="{{ route('events.indexhvtv3')}}">TƯ VẤN 3</a></li>
              ...
              <div class="panel-body">    
                   ...
                   {!! Form::open(array('route' => 'events.addhvtv2','method'=>'POST','files'=>'true')) !!}
                    <div class="row">
                      ...
                      <input type="text" value="Phòng Tư vấn 2" name="diadiem" style="display: none">
