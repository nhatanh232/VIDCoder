...
<tr><th scope="row">Tổng</th>
		...
		<td></td>
	<td>
		<input type="text" name="Thu2" disabled placeholder="{{$tongphan1}}" style="width: 62px;"> 
	 </td>
	  <td>
		<input type="text"  name="Thu3" disabled placeholder="{{$tongphan13}}" style="width: 62px;">
	</td> 
	<td>
		<input type="text"  name="Thu2" disabled placeholder="{{$tongphan14}}" style="width: 62px;"> 
	 </td>
	  <td>
		<input type="text"  name="Thu3" disabled placeholder="{{$tongphan15}}" style="width: 62px;">
	</td>
	 <td>
		<input type="text" name="Thu3" disabled placeholder="{{$tongphan16}}" style="width: 62px;">
	</td>
