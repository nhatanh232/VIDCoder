...
<script src="//code.jquery.com/jquery-1.11.1.min.js"></script>
 <link rel="stylesheet" type="text/css" href="{{asset('layouts/css/hovereffect.css')}}">
</head>
<style type="text/css">
	.productbox {
...
<h1 style="text-align: center;">DANH SÁCH SẢN PHẨM CẦN TÌM</h1>
@foreach ($data as $key)
<div class="col-lg-3 col-md-4 col-sm-6 col-xl-12">
 <div class="hovereffect">
 	 <img src="{{URL::asset('layouts/images/QLKho')}}/{{$key->Hinh}}" class="img-responsive" >
<div class="overlay">
   
    <div class="producttitle" style="font-weight: bold;color: yellow"><h4>{{$key->Ten}} - MVT:{{$key->MVT}}</h4>
    	<p style="font-family: Arial;">{{$key->Thongso}}</p>
    </div>
