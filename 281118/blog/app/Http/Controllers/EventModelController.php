...
; 
        ...
        return view('datlich.phongkai', compact('calendar') )->with('email',$users);
    }
...
public function addEvent(Request $request)
    {
        ...
        $dieukien = \DB::Table('event_models_phongkai')->Select()->where('start','<=',$convertbd)->where('end','>=',$convertkt)->count();
