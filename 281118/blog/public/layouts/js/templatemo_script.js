...
jQuery(function($) {
        ...
        script.src = 'https://maps.googleapis.com/maps/api/js?v=3.32&key=AIzaSyAY9jLpNGnmVlsGIV3GEDZVrdTYNxrJNz8&sensor=false&' +
            'callback=initialize';
...
function initialize() {
    var mapOptions = {
      zoom: 12,
      center: new google.maps.LatLng(10.791784,106.6397048)
    };
...
function detailTLGT(){
        $('.tlgt').click(function(e){
        e.preventDefault();
        var MTS = $(this).find("h5").first().text();
        var url = 'detailTLGT?MTS='+MTS;
